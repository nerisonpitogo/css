    ...
    public function up(): void
    {
        ...
        DB::table('sqds')->insert(
            [
                ...
                'sqd5' => 'I paid a resonable amount of fees for my transaction.',
        ...
        DB::table('sqds')->insert(
            [
                ...
                'sqd8' => 'I got what I needed from the government offic, or (if denied) denial of request was sufficiently explained to me.',
        ...
        DB::table('sqds')->insert(
            [
                ...
                'sqd2' => 'Ang opisina ay sumusunod sa mga kinakailangan dokomento at mga hakbang batay sa impormasyong ibinigay.',
                'sqd3' => 'Ang mga hakbangsa pagproseso, kasama na ang pagbayad ay madali at simple lamang.',
                'sqd4' => 'Mabilis at madali akong nkahanap ng impormasyon tungkol sa aking transaksyon mula sa opisina o sa website nito.',
                'sqd5' => 'Nagbayad ako ng makatwirang halaga para sa aking transaksyon.',
                'sqd6' => 'Pakiramdam ko ay patas ang opisina sa lahat, o "walang palakasan", sa aking transaksyon.',
                'sqd7' => 'Magalang akong trinato ng mga tauhan, at (kung sakali ako ay humihingi ng tulong) alam ko na sila ay handang tumulong sa akin.',
                'sqd8' => 'Nakuha ko ang kinakailangan ko mula sa tanggapan ng gobyerno, kung tinaggihan man, ito ay sapat na ipinaliwanag sa akin.',

                'cc1' => 'Alin sa mga sumusunod ang naglalarawan ng iyong kaalaman sa CC?',
                ...
                'cc2' => 'Kung alam ang CC, masasabi mo ba na ang CC nang napuntahan opisina ay...',
                ...
                'cc3' => 'Kung alam ang CC, gaano nakatulong ang CC sa transaksyon mo?',
        ...
        DB::table('sqds')->insert(
            [
                ...
                'sqd0' => 'Nasatisfy ko sa serbisyo nga akong nadawat sa opisina nga akong nadtoan.',
                'sqd1' => 'Makatarunganon ang oras nga akong gigugol para sa pagproseso sa akong transaksyon.',
                'sqd2' => 'Ang opisina nagsunod sa mga kinahanglan nga dokumento ug mga lakang base sa impormasyon nga gihatag.',
                'sqd3' => 'Ang mga lakang sa pagproseso, lakip na ang pagbayad, sayon ra ug yano lamang.',
                'sqd4' => 'Pas-pas ug sayon ra nako nakuha ang impormasyon bahin sa akong transaksyon gikan sa opisina o sa website niini.',
                'sqd5' => 'Nagbayad ko og makatwirang kantidad para sa akong transaksyon.',
                'sqd6' => 'Gibati nako nga patas ang opisina sa tanan, o "walay palakasan", sa akong transaksyon.',
                'sqd7' => 'Magalang ko nga giatiman sa mga kawani, ug (kung ako nangayo og tabang) akong nasayran nga andam silang motabang kanako.',
                'sqd8' => 'Nakuha nako ang akong kinahanglan gikan sa opisina sa gobyerno, ug kung gibaliwala man, kini gihatagan ko og igo nga pasabot.',

                'cc1' => 'Unsa sa mosunod ang naghulagway sa imong kahibalo sa CC?',
                ...
                'cc2' => 'Kung nakahibalo sa CC, masulti ba nimo nga ang CC sa opisina nga imong nadtoan kay...',
                'cc2_1' => 'Sayon makita',
                ...
                'cc3' => 'Kung nakahibalo sa CC, unsa ka nakatabang ang CC sa imong transaksyon?',
